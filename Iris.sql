CREATE DATABASE  IF NOT EXISTS `iris` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `iris`;
...
CREATE TABLE `iris` (
  `Id` int DEFAULT NULL,
  `SepalLengthCm` double DEFAULT NULL,
  `SepalWidthCm` double DEFAULT NULL,
  `PetalLengthCm` double DEFAULT NULL,
  `PetalWidthCm` double DEFAULT NULL,
  `Species` text
...
-- Dump completed on 2025-04-20 18:08:37
